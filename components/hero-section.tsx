...
export function HeroSection({
  ...
  return (
    <section className="w-full pt-2 min-h-[calc(100vh-4rem)] px-4 py-8 flex items-center mb-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 lg:gap-8">
        <div className="max-w-3xl self-center justify-self-center">
          <h1
            className=" mb-6 lg:mb-30 text-center text-4xl sm:text-5xl font-light uppercase tracking-wide lg:text-6xl"
        ...
        <div className="flex-shrink-0 transition-opacity duration-300 self-center justify-self-center lg:justify-self-center -translate-y-4 md:-translate-y-24" style={{ opacity: showLogo ? 1 : 0 }} aria-hidden={!showLogo}>
          {useAnimatedLogo ? (
            <div className="mx-auto lg:mx-0" style={{ width: currentSize, height: currentSize }}>
              <WinkSmileyGSAP
                size={currentSize}
                color="#FFB80F"
